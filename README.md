...
[![CI](https://github.com/namitdeb739-aug/test-ml-project/actions/workflows/ci.yml/badge.svg)](https://github.com/namitdeb739-aug/test-ml-project/actions/workflows/ci.yml)
[![Docs](https://github.com/namitdeb739-aug/test-ml-project/actions/workflows/docs.yml/badge.svg)](https://namitdeb739-aug.github.io/test-ml-project/)
[![CodeQL](https://github.com/namitdeb739-aug/test-ml-project/actions/workflows/codeql.yml/badge.svg)](https://github.com/namitdeb739-aug/test-ml-project/actions/workflows/codeql.yml)
...
```bash
git clone https://github.com/namitdeb739-aug/test-ml-project.git
cd test-ml-project
just init
```
...
.
├── src/
│   └── test_ml_project/          # Source package (src layout)
│       ├── __init__.py
│       ├── main.py            # Entry point
...
The docs site will be available at `https://namitdeb739-aug.github.io/test-ml-project/`.
...
2. Enter: GitHub repo `namitdeb739-aug/test-ml-project`, workflow `publish.yml`, environment `pypi`
...
4. Runs via `uv run test-ml-project`
...
```bash
just docker-build-gpu    # or: docker build -f Dockerfile.gpu -t test-ml-project-gpu .
```
...
The template uses [bump-my-version](https://github.com/callowayproject/bump-my-version) to keep version numbers in sync across `pyproject.toml` and `src/test_ml_project/__init__.py`:
...
| `src/test_ml_project/config.py` | Typed dataclass configuration (see below) |

### Configuration

`src/test_ml_project/config.py` provides a typed, dataclass-based config pattern:

```python
from test_ml_project.config import Config
